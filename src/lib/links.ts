...
export const categoryLinks: Record<string, CategoryData> = {
    ...
    adult: {
        title: "Adult (18+)",
        kanji: "🔞",
        romaji: "Adult / Restricted",
        tagline: "Age-restricted resources; use appropriate filters and safeguards",
        icon: "🔞",
        links: [
            { name: "playbox.com", url: "https://www.playbox.com/", icon: bulletIcon },
            { name: "ourdream.ai", url: "https://ourdream.ai/", icon: bulletIcon },
            { name: "candy.ai", url: "https://candy.ai/", icon: bulletIcon },
            { name: "pornito.net", url: "https://pornito.net/", icon: bulletIcon },
            { name: "egooners.com", url: "https://egooners.com/", icon: bulletIcon },
            { name: "pornhub.com", url: "https://pornhub.com/", icon: bulletIcon },
            { name: "redtube.com", url: "https://redtube.com/", icon: bulletIcon },
            { name: "beeg.com", url: "https://beeg.com/", icon: bulletIcon },
            { name: "spankbang.com", url: "https://spankbang.com/", icon: bulletIcon },
            { name: "fapello.com", url: "https://fapello.com/", icon: bulletIcon },
            { name: "erothots.is", url: "https://erothots.is/", icon: bulletIcon },
            { name: "stripchat.com", url: "https://stripchat.com/", icon: bulletIcon },
            { name: "bongacams.com", url: "https://bongacams.com/", icon: bulletIcon },
            { name: "camsoda.com", url: "https://camsoda.com/", icon: bulletIcon },
            { name: "sex.com", url: "https://sex.com/", icon: bulletIcon },
            { name: "nsfw.xxx", url: "https://nsfw.xxx/", icon: bulletIcon },
            { name: "redgifs.com", url: "https://redgifs.com/", icon: bulletIcon },
            { name: "hanime.tv", url: "https://hanime.tv/", icon: bulletIcon },
            { name: "rule34.xxx", url: "https://rule34.xxx/", icon: bulletIcon },
            { name: "hentaihaven.xxx", url: "https://hentaihaven.xxx/", icon: bulletIcon },
            { name: "kemono.cr", url: "https://kemono.cr/", icon: bulletIcon },
        ],
    },
    adblockers: {
        title: "AdBlockers",
